...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[90vh] flex items-center pt-32 pb-20 overflow-hidden bg-brand-blue">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 grid lg:grid-cols-2 gap-12 items-center h-full">
        ...
        >
          ...
          <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl border-2 border-white/20 bg-brand-darkBlue/30">
             ...
             */}
             <img 
               src="/images/png-transparent-ford-car-mechanics-graphy-ford-tshirt-blue-car-thumbnail-removebg-preview.png" 
             ...
             <motion.div 
               ...
               className="absolute top-1/2 -translate-y-1/2 left-0 bg-white/95 backdrop-blur-sm p-8 rounded-r-3xl shadow-2xl flex items-center gap-6 border-y border-r border-gray-100 max-w-sm transform transition-all hover:scale-105 z-20"
             >
