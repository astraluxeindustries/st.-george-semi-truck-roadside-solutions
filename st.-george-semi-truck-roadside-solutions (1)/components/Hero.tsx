          ...
          <div className="relative w-full h-full overflow-visible bg-transparent">
             ...
             */}
             ...
             <motion.div 
               ...
               className="absolute top-[60%] -translate-y-1/2 left-0 bg-white/95 backdrop-blur-sm p-3 rounded-3xl shadow-2xl flex items-center gap-5 border-y border-r border-gray-100 max-w-sm transform scale-50 transition-all hover:scale-95 z-20"
             >
